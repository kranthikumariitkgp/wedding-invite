(function ($) {
  $(document).ready(function () {
    ...
    function send_form (type) {
      ...
      console.log("attend", attending);

      var dataString = 'entry.993890504=' + name + '&entry.467769740=' + email + '&entry.901935844=' + guest + '&entry.1951656656=' + attending;
      var form = $(this);
      var str = form.serialize();
      function sent(){
        $('#div_' + type).html("<div id='form_send_message'>Thank You. I'll be looking forward to it.</div>", 1500);
      }
      console.log("dataString", dataString);
      $.ajax({
        type: "POST",
        crossDomain: true,
        url: "https://docs.google.com/forms/d/e/1FAIpQLSdmXc6N3lKl1B94DJeL7o832JA5W0HJoJFF8C8ewA8_Lr8uUA/formResponse",
        data: dataString,
        complete:sent
      });
    }
    ...
    /*CountDown*/
    $('.married_coundown').countdown({until: new Date("Feb 21, 2019 11:49:00")});
